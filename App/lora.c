...
#define LORASTACKSIZE   2048

Task_Struct loraTaskStruct;
Char loraTaskStack[LORASTACKSIZE];
...
void LORA_CreateTask(int priority){

    /* Create pwm Task */
    Task_Params TaskParams;
    Task_Params_init(&TaskParams);

    TaskParams.stackSize = LORASTACKSIZE;
    TaskParams.stack = &loraTaskStack;
    TaskParams.priority = priority;
    TaskParams.instance->name = "lora_Task";
    Task_construct(&loraTaskStruct, (Task_FuncPtr) loraMainTask, &TaskParams,NULL);
